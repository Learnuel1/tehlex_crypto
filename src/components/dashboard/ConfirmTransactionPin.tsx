import { Box, Button, Flex, Heading, HStack, PinInput, PinInputField, Stack, Text, VStack, Image } from '@chakra-ui/react'
    ...
    return (
        <Box maxW={'100vw'} p='2rem' minH={'40vw'} fontFamily='Mulish'>
            ...
            <VStack gap={'2rem'} mt={{ base: '80px', md: '0px' }}>
                <Heading size={'md'} color={{ base: '#303030', md: 'inherit' }} fontFamily='Mulish' fontSize={{ base: '24px', md: 'inherit' }}>Confirm your new PIN</Heading>

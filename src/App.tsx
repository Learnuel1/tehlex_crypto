...
import ResetEmailPin from "./components/ResetPhonePin"
...
import './App.css'
import ResetPhonePin from "./components/ResetPhonePin"
    ...
    <>
      <Routes>
        <Route path="/" element={<SharedComponent />}>
          ...
          <Route path="resetphonepin" element={<ResetPhonePin />} />
          <Route path="resetmailpin" element={<ResetEmailPin />} />
